...
Route::group(['namespace' => '\Acelle\Http\Controllers', 'middleware' => ['not_installed', 'not_logged_in']], function () {
    ...
    Route::get('/login/token/{token}', 'AppController@tokenLoginWithToken');
...
Route::group(['namespace' => '\Acelle\Http\Controllers', 'namespace' => '\Acelle\Http\Controllers', 'middleware' => ['not_installed', 'auth', 'frontend', 'subscription', '2fa']], function () {
    ...
    Route::match (['get', 'post'], 'automation/wizard/template', 'Automation2Controller@wizardTemplate');
...
Route::group(['namespace' => '\Acelle\Http\Controllers\Admin', 'middleware' => ['not_installed', 'auth', 'backend', '2fa']], function () {
    ...
    Route::post('admin/sending_servers/{uid}/testSms', 'SendingServerController@testSms');
    Route::get('admin/sending_servers/{uid}/testSms', 'SendingServerController@testSms');
    Route::match (['get', 'post'], 'sending_server/{uid}/test-send-sms', 'SendingServerController@testSendSms')->name('sending_server.test_sms');
