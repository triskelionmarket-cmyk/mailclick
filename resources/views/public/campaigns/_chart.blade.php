...
<div class="row">
            ...
            <div class="">
                <div class="chart-container">
                    <div id="campaignChart"
                        ...
                        data-url="{{ action('Pub\CampaignController@chart', [ 'uid' => $campaign->uid, 'customer_uid' => $campaign->customer->uid ]) }}"
    ...
    <div class="col-md-6">
        <div class="badge-row">
            ...
            <a class="text-warning" href="{{ action('Pub\CampaignController@openLog', [ 'uid' => $campaign->uid, 'customer_uid' => $campaign->customer->uid ]) }}"><span class="material-symbols-rounded">arrow_forward</span> {{ trans('messages.view_log') }}</a>
        </div>
        ...
        <div class="badge-row">
            ...
            <a class="text-warning" href="{{ action('Pub\CampaignController@subscribers', ['customer_uid' => $campaign->customer->uid, 'uid' => $campaign->uid, 'open' => 'not_opened']) }}"><span class="material-symbols-rounded">arrow_forward</span> {{ trans('messages.view_log') }}</a>
        </div>
        ...
        <div class="badge-row">
            ...
            <a class="text-warning" href="{{ action('Pub\CampaignController@clickLog', [ 'uid' => $campaign->uid, 'customer_uid' => $campaign->customer->uid ]) }}"><span class="material-symbols-rounded">arrow_forward</span> {{ trans('messages.view_log') }}</a>
        </div>
        ...
        <div class="badge-row">
            ...
            <a class="text-warning" href="{{ action('Pub\CampaignController@unsubscribeLog', [ 'uid' => $campaign->uid, 'customer_uid' => $campaign->customer->uid ]) }}"><span class="material-symbols-rounded">arrow_forward</span> {{ trans('messages.view_log') }}</a>
        </div>
        ...
        <div class="badge-row">
            ...
            <a class="text-warning" href="{{ action('Pub\CampaignController@bounceLog', [ 'uid' => $campaign->uid, 'customer_uid' => $campaign->customer->uid ]) }}"><span class="material-symbols-rounded">arrow_forward</span> {{ trans('messages.view_log') }}</a>
        </div>
        ...
        <div class="badge-row">
            ...
            <a class="text-warning" href="{{ action('Pub\CampaignController@feedbackLog', [ 'uid' => $campaign->uid, 'customer_uid' => $campaign->customer->uid ]) }}"><span class="material-symbols-rounded">arrow_forward</span> {{ trans('messages.view_log') }}</a>
        </div>
