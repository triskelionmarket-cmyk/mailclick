...
@section('content')
  <div class="row">
    <div class="col-md-12 tex-center">
      <form data-control="form-with-captcha" action="{{ action('MailListController@embeddedFormSubscribe', [ 'uid' => $list->uid, 'customer_uid' => $list->customer->uid]) }}" method="POST" class="form-validate-jqueryz">
