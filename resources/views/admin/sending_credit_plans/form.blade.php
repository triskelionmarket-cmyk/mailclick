<h4>{{ trans('messages.sending_credit_plan.details') }}</h4>
<div class="mb-4">
    <div class="mb-3">
        <label class="form-label">{{ trans('messages.sending_credit_plan.plan_name') }}</label>
    ...
    <div class="mb-3">
        <label class="form-label">{{ trans('messages.sending_credit_plan.description') }}</label>
    ...
    <div class="mb-3">
        <label class="form-label">{{ trans('messages.sending_credit_plan.credits') }}</label>
