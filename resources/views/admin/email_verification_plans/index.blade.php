...
@section('content')
    ...
    <div class="row">
        <div class="col-md-8"><p>{{ trans('messages.email_verification_plan.intro') }}</p></div>
    </div>
    ...
    >
        <div class="d-flex top-list-controls top-sticky-content">
            ...
            @can('create', new Acelle\Model\PlanGeneral())
                <div class="text-end">
                    <a href="{{ action('Admin\EmailVerificationPlanController@create') }}" role="button" class="btn btn-secondary">
    ...
    <script>
        var PlanIndex = {
            getList: function() {
                return makeList({
                    url: '{{ action('Admin\EmailVerificationPlanController@list') }}',
