<div class="mb-20">
    <input type="hidden" name="options[type]" value="woo-order-completed" />
                ...
                <div class="settings">
                    <div class="d-flex my-2 py-1">
                        ...
                        <div class="setting-content">
                            {!! trans('messages.automation.trigger.woo_order_completed.connected', [
                                'store' => $shopinfo['name'],
                            ]) !!}
                        </div>
                    </div>
                    <div class="d-flex my-2 py-1">
                        ...
                        <div class="setting-content">
                            {{ trans('messages.automation.trigger.woo_order_completed.description') }}
                        </div>
                    </div>
                </div>
            </div>
