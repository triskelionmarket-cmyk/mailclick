...
<head>
    ...
    @if (Acelle\Model\Plugin::isInstalled('acelle/chatgpt') &&
    Acelle\Model\Plugin::getByName('acelle/chatgpt')->isActive())
    <!-- ChatGPT -->
    ...
    <script>
        ...
        // E-Commerce widgets (always available)
        ...
        // Utility widgets
        editor.addWidget(new SpacerWidget(), {
            index: 4,
        });
